          ...
          <div class="col-lg-3">
            ...
            <div class="col-lg-9 mt-4 mt-lg-0">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{URL::asset('assets/client/img/specials-2.png')}}" alt="" class="img-fluid">
                  </div>
                </div>
              </div> -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{URL::asset('assets/client/img/specials-3.png')}}" alt="" class="img-fluid">
                  </div>
                </div>
              </div> -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{URL::asset('assets/client/img/specials-4.png')}}" alt="" class="img-fluid">
                  </div>
                </div>
              </div> -->
                    <div class="tab-pane active show" id="tab-5">
                        <div class="row" style="align-items: center;">
                            ...
                            <div class="col-lg-8 details order-2 order-lg-1" style="padding-left:50px;">
                                ...
                                <h4>
                                    <p class="font-italic">Brand: {{$ans->brand}}</p>
                                </h4>
